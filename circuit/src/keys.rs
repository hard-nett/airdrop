...
pub mod testing {
    ...
    use super::{DiversifierIndex, DiversifierKey, EligibleSk, EphemeralSecretKey, SpendingKey};
    ...
    prop_compose! {
        ...
        pub fn arb_elig_sk()(
            esk in prop::array::uniform32(prop::num::u8::ANY)
                .prop_map(|b| EligibleSk::from_bytes(b))
...
mod tests {
    ...
    //         let recp = crate::address::RecpAddr::try_from(
    //             mock_deps
    //                 .api
    //                 .addr_canonicalize(
    //                     &mock_deps
