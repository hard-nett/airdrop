...
| Example |Description   |   |
|---------------------------|------| -|
| plume demo | demo plume proof verification instance ||
| pedersen | demostrate pedersen commitments for perfect secretct ||
| gen headstash notes | demo plume proof verification instance |
| gen headstash keys | generate circuit verifying and proving keys |
