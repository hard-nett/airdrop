...
use crate::{
    ...
    value::{NoteDenom, NoteValue, Sign, ValueCommitTrapdoor, ValueCommitment, ValueSum},
...
impl Spend {
    ...
    pub fn parse(
        ...
        let fvk = fvk
            ...
            .transpose()?;
        let esk = esk.map(|esk| EligibleSk::from_bytes(esk));
        let witness = witness
...
impl Output {
    ...
    pub fn parse(
        ...
        let esk = esk.map(|r| EligibleSk::from_bytes(r));
